...
(function() {
  ...
  loadCSS('lib/print.css', 'print');
  loadCSS('lib/presentation.css?x=' + rnd, 'screen');
  loadCSS('lib/yui3-rfb.css?x=' + rnd, 'all');

  loadJS('lib/head.min.js', function() {
    head.feature("isTouch", function() { return 'ontouchstart' in window; });
    head.js('lib/webfont.min.js')
        .js('lib/jquery.min.js')
        .ready(function() {
          head.js('lib/presentation.js?x=' + rnd, function() {
